...
import {changeDefaultDailyHours} from '../../redux/slices/providersSlice';
import {TimeRange} from '../../types';

const UpdateProviderDefaultAvailabilityPage = () => {
  ...
  return (
    <>
      ...
      <h1 style={{ marginBottom: '36px' }}>Update Default Availability</h1>
      <div
